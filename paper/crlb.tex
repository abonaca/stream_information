...
\label{sec:res_comp}
- each stream provides information on individually on its progenitor, and on the common Galactic model
- in this section we compare how different streams constrain different aspects of the gravitational field

- compare CRB ellipses for halo parameters between all streams
- comment on relative sizes, correlations of CRLBs
- comment on relative importance of different data (and defer a more in-depth analysis to Section \S\,\ref{sec:forecast})
