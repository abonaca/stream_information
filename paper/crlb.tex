...
\hline
\hline
Data set & $\sigma_\eta$ (deg) & $\sigma_d$ (kpc) & $\sigma_{V_r}$ (km\,s$^{-1}$) & $\sigma_{\mu_\alpha}$ (mas\,yr$^{-1}$) & $\sigma_{\mu_\alpha}$ (mas\,yr$^{-1}$) \\
\hline
\input{obsmodes}
\hline
\hline
...
For simplicity, we adopt a single value of $2\,\rm kpc$ as our fiducial uncertainty in distance, which is realistic for nearby streams, but perhaps overly optimistic for the more distant streams.
