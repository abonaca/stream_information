...
If the condition number of $C_x^{-1}$ is small, it can be easily inverted to obtain the Cram\'er--Rao bounds.
...
Once we have the inverse of the Fisher matrix, the square root of its diagonal are the CRLB, which measure the best attainable precision in the 15 parameters of our model.
