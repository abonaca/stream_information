...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{../plots/obsmode_comparison_vh.pdf}
...
Each panel shows constraints on a single parameter, with different streams spaced along the x-axis, and ordered by the precision they reach in halo scale velocity, $V_h$, in the fiducial 6D case.
