...
In our current implementation, we use the standard, unreliable inverse as the starting guess $Q$, and convergence is typically obtained after $\sim\;10$ iterations.
